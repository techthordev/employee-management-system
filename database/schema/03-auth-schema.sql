...
GRANT ALL ON SCHEMA auth TO springconnector;
...
-- Privileges
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA auth TO springconnector;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA auth TO springconnector;
